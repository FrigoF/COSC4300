...
//
// To compile: gcc -Wall -o tsyslog tsyslog.c
...
{ 
    ...
    sprintf(rfc5424_syslog_msg, "<%d>%d %s %s TCP %s %d %c RFC5424 message from %s: %s", 
       pri, version, rfc5424_time, myHost, "tsyslog", pid, '-', username,  myMessage );
